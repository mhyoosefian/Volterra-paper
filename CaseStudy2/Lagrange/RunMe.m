...
E = Energy(Ixx,Ixy,Ixz,Iyy,Iyz,Izz,a,b,c,dq1,dq2,dq3,dq4,dq5,dq6,dq7,dq8,m_p,m_s,q1,q2,q3,q4,q5);
E_Err_Lag = (E-E(1))/E(1);
save('E_Err_Lag');
X = ['Norm of Energy Error = ',num2str(norm((E-E(1))/E(1)))];
disp(X);
%% Linear momentum criteria
LM = Lmoment(b,dq1,dq2,dq3,dq4,dq5,dq6,dq7,dq8,m_p,m_s,q1,q2,q3,q4,q5);
LMX = LM(1:length(t));
